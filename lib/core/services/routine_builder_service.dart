/// Daily Routine Builder ΓÇö ordered step sequences for structured daily workflows.
///
/// Unlike individual habits, routines are **ordered sequences** of steps
/// (e.g., "Morning Routine: wake ΓåÆ meditate 10m ΓåÆ exercise 30m ΓåÆ shower 15m").
///
/// Features:
...
/// A routine definition ΓÇö an ordered collection of steps with scheduling.
class Routine {
  /// Unique identifier.
  final String id;
