...
Everything App includes **100+ features** organized into 7 categories. Each feature has a dedicated screen and service with local persistence.
...
| **Analytics** | Charts and statistics across all tracked data |
| **Chore Tracker** | Manage household chores with rotation and scheduling |
...
| **Price Tracker** | Monitor price changes for items you want to buy |
...
├── models/              # Data models (one per feature domain)
├── state/
│   ├── blocs/           # BLoC pattern for events
│   └── providers/       # ChangeNotifier providers
└── views/
    ├── home/            # Feature screens (one per feature)
